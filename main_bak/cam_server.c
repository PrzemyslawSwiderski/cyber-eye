...
#define EXAMPLE_CAMERA_VIDEO_BUFFER_NUMBER 2
...
#define EXAMPLE_PART_BOUNDARY "123456789000000000000987654321"
...
void cam_server_start(void)
{

  esp_err_t ret = ESP_OK;
  bsp_camera_cfg_t cfg = {};

  ret = bsp_camera_start(&cfg);
